...
export default function Attendance() {
    ...
    const [attendance, setAttendance] = useState<{ [key: number]: { lesson1: boolean; lesson2: boolean; lesson3: boolean } }>({});

    const handleCheckboxChange = (studentId: number, lesson: "lesson1" | "lesson2" | "lesson3") => {
                                ...
                                <tr key={student.id}>
                                    ...
                                    <td className="py-3 px-4 border-b text-center">
                                        <input
                                            ...
                                            onChange={() => handleCheckboxChange(student.id, "lesson1")}
                                        />
                                    </td>
                                    <td className="py-3 px-4 border-b text-center">
                                        <input
                                            ...
                                            onChange={() => handleCheckboxChange(student.id, "lesson2")}
                                        />
                                    </td>
                                    <td className="py-3 px-4 border-b text-center">
                                        <input
                                            ...
                                            onChange={() => handleCheckboxChange(student.id, "lesson3")}
                                        />
                                    </td>
                                </tr>
                            ))}
