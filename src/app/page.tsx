      ...
      <div className="container mx-auto flex flex-wrap items-center justify-between">
        ...
        <nav className={`md:flex md:items-center ${isOpen ? 'block' : 'hidden'}`}>
          <ul className="flex flex-col md:flex-row md:space-x-6 items-center">
            <li>
              <a href="#home" className="block py-2 px-4 hover:text-uniporraGreen2">Início</a>
            </li>
            <li>
              <a href="#modalidades" className="block py-2 px-4 hover:text-uniporraGreen2">Modalidades</a>
            </li>
            <li>
              <a href="#sobre" className="block py-2 px-4 hover:text-uniporraGreen2">Sobre</a>
            </li>
            <li>
              <a href="#contact" className="block py-2 px-4 hover:text-uniporraGreen2">Contato</a>
            </li>
            <li>
              <a href="/login" className="block bg-white text-uniporraGreen3 px-4 py-2 rounded-lg hover:bg-uniporraGreen2 hover:text-white transition-all">Entrar</a>
            </li>
          </ul>
        </nav>
      </div>
  ...
  return (
    <section id="home" className="bg-uniporra2 py-20">
      <div className="container mx-auto text-center">
        ...
        <a href="#modalidades" className="bg-uniporra text-white py-3 px-6 rounded-full hover:bg-uniporraGreen1 transition-all">
          Ver planos
        </a>
      </div>
    </section>
    ...
    <section id="contact" className="py-20 bg-uniporraBlack">
      <div className="container mx-auto text-center text-white">
        ...
        <p className="text-lg mb-8">
          Se você tiver alguma dúvida ou quiser mais informações, entre em contato conosco. Estamos aqui para ajudar!
        </p>
        <form className="max-w-lg mx-auto text-white">
          <div className="mb-4">
            <label className="block text-left mb-2" htmlFor="name">Nome</label>
            <input type="text" id="name" className="w-full px-4 py-2 border border-uniporraGray rounded-lg" placeholder="Seu nome" />
          </div>
          <div className="mb-4">
            <label className="block text-left mb-2" htmlFor="email">Email</label>
            <input type="email" id="email" className="w-full px-4 py-2 border border-uniporraGray rounded-lg" placeholder="Seu email" />
          </div>
          <div className="mb-4">
            <label className="block text-left mb-2" htmlFor="message">Mensagem</label>
            <textarea id="message" rows={4} className="w-full px-4 py-2 border border-uniporraGray rounded-lg" placeholder="Sua mensagem"></textarea>
          </div>
          <button type="submit" className="bg-uniporra text-white py-2 px-6 rounded-full hover:bg-uniporraGreen1 transition-all">Enviar</button>
        </form>
      </div>
    </section>
  );
  ...
  return (
    <section id="sobre" className="py-20 bg-uniporra2">
      <div className="container mx-auto text-center">
        ...
        <p className="text-lg mb-8 text-uniporraBlack">
          A Unisport é uma instituição dedicada ao desenvolvimento de atletas e entusiastas do esporte. Com uma equipe de profissionais altamente qualificados e um ambiente de aprendizagem estimulante, oferecemos programas personalizados para atender às necessidades de cada aluno.
        </p>
        <p className="text-lg text-uniporraBlack">
          Nosso objetivo é proporcionar uma experiência esportiva enriquecedora e ajudar nossos alunos a atingir seu potencial máximo.
        </p>
      </div>
    </section>
  );
